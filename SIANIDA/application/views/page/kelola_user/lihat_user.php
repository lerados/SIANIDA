		...
		<tr>
			<td height="400px" valign="top">
				<div class="col-md-12" align="center">
					...
					<tr>
						<td>
							<a href="" data-toggle="modal" data-target=".tambah"><button type="button" class="btn btn-primary">Tambah User</button></a>
						</td>
					</tr>
					</table>
				  	<table class="table table-bordered table-condensed table-hover handap" align="center">
					<?php
						if($ses['proses'] == 'gagal_tambah'){
							echo "<tr><td colspan='9' align='center'><font color='red'>".$ses['teks']."</font></td></tr>";
						}
						elseif($ses['proses'] == 's_hapus'){
							echo "<tr><td colspan='9' align='center'><font color='red'>".$ses['teks']."</font></td></tr>";
						}
					?>
...
<div class="modal fade tambah" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
				<h4 class="modal-tittle" align="center">User Baru</h4>
			</div>
			<div class="modal-body">
				<form method="post" action="?p=proses_tambah_user">
					<input type="hidden" name="aidi" value="<?php echo date('YmdHis'); ?>">
					<table class="table-condensed table-hover" align="center">
					<tr>
					...
					<tr>
						...
						<td>
							<select name="level" class="form-control">
								<option value="K">Kapus</option>
								<option value="U">UP</option>
								<option value="P" selected>PT</option>
							</select>
						</td>
					</tr>
					<tr>
					...
					<tr>
						<td align="top">Alamat</td>
						<td>
							<textarea name="alamat" class="form-control" rows="3" placeholder="Alamat" required="True"></textarea>
						</td>
					</tr>
					<tr>
						<td>Jabatan</td>
						<td>
							<select name="jabatan" class="form-control">
								<option value="Kepala Persuratan">Kepala Persuratan</option>
								<option value="Unit Persuratan">Unit Persuratan</option>
								<option value="Pejabat Terkait" selected>Pejabat Terkait</option>
							</select>
						</td>
					</tr>
					<tr>
						<td>Tanggal Lahir</td>
						<td>
							<input type="date" name="tgl_lahir" class="form-control" required="True">
						</td>
					</tr>
					<tr>
						<td>Kontak</td>
						<td>
							<input type="text" name="kontak" class="form-control" placeholder="Kontak" required="True">
						</td>
					</tr>
					<tr>
						<td colspan="2">
							<input type="submit" class="btn btn-info" name="user_tambah" value="Simpan">
							<button type="button" class="btn btn-primary" data-dismiss="modal">Kembali</button>
						</td>
					</tr>
					</table>
